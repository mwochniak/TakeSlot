...
namespace TakeSlot.Api.Filters;
...
public static class ValidationFilter
{
    ...
    {
        IEnumerable<ValidationDescriptor> validationDescriptors = GetValidators(context.MethodInfo, context.ApplicationServices).ToList();
